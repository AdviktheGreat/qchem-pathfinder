# Research exploration profile format

Profiles are UTF-8 plain text. Uppercase headings are stable section boundaries.
They contain no student name or identifier. Consumers should parse headings,
not line numbers, because keyword counts and preparation steps may change.
...
For the literature prompt kit, preserve recommendation context and the final
citation-verification note. Treat suggested searches as queries, never as
paper citations or evidence that a particular study exists.
